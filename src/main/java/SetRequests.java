...
public class SetRequests {
    ...
    public void createJSON() throws SQLException {
        ...
        for (Client c : clients){
            ...
            if (c.getSite().equals("http://petrobitovki.ru/domiki")){
                j.put("name","Tracker-DD " + c.getPhoneFirst());
                j.put("note", "Client from Tracker-DD" + "\n" + c.getPhoneFirst() + "\n" + c.getPhoneSecond());
                clientId_Site.add("Tracker-DD+" + c.getPhoneFirst());
            }
